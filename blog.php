...
<head>
   ...
   <title>Apna House Designs || Blog</title>
           ...
           <div class="row">
              <div class="col-lg-12">
                 <nav class="navbar navbar-expand-lg navbar-light">
                  <a class="navbar-brand" href="index.html"> <img src="img/websitelogo.png" alt="logo"> </a>
                    ...
                    <div class="collapse navbar-collapse main-menu-item" id="navbarNav">
                       ...
                       <a class="btn btn-danger text-white" href="contact.html">Get Quote</a>
                     </span>
                    </div>
                 </nav>
              </div>
